...
proc verifyNodesRecords(enrs: openArray[SignedPeerRecord], fromNode: Node, nodesLimit: int,
...
proc verifyNodesRecords*(enrs: openArray[SignedPeerRecord], fromNode: Node, nodesLimit: int): seq[Node] =
  verifyNodesRecords(enrs, fromNode, nodesLimit, none[seq[uint16]]())

proc verifyNodesRecords*(enrs: openArray[SignedPeerRecord], fromNode: Node, nodesLimit: int, distances: seq[uint16]): seq[Node] =
